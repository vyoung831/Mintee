...
class Task_InstanceDeltaTests: XCTestCase {
    ...
    let globalDowDates: Set<String> =  Set(["2020-01-03",
    ...
    let globalWomDates: Set<String> = Set(["2020-01-01", "2020-01-08", "2020-01-15", "2020-01-22", "2020-01-29",
    ...
    let globalDomDates: Set<String> = Set(["2020-01-01", "2020-01-02", "2020-01-03", "2020-01-04", "2020-01-05", "2020-01-06", "2020-01-07", "2020-01-08", "2020-01-09", "2020-01-10",
...
extension Task_InstanceDeltaTests {
...
extension Task_InstanceDeltaTests {
    ...
    func testGetDeltaInstancesRecurring_startDateEarlier() throws {
    ...
    func testGetDeltaInstancesRecurring_startDateLater() throws {
    ...
    func testGetDeltaInstancesRecurring_endDateEarlier() throws {
        
        let newDowDates: Set<String> = Set(["2020-01-03",
                                       "2020-01-05", "2020-01-06", "2020-01-07", "2020-01-10",
                                       "2020-01-12", "2020-01-13", "2020-01-14", "2020-01-17",
                                       "2020-01-19", "2020-01-20", "2020-01-21", "2020-01-24",
                                       "2020-01-26", "2020-01-27", "2020-01-28", "2020-01-31",
        ...
        let newWomDates: Set<String> = Set(["2020-01-01", "2020-01-08", "2020-01-15", "2020-01-22", "2020-01-29",
                                       "2020-02-05", "2020-02-12", "2020-02-19", "2020-02-26",
                                       "2020-03-04", "2020-03-11", "2020-03-18", "2020-03-25",
                                       "2020-04-01", "2020-04-08", "2020-04-15", "2020-04-22", "2020-04-29",
                                       "2020-05-06", "2020-05-13", "2020-05-20", "2020-05-27",
                                       "2020-06-03", "2020-06-10", "2020-06-17", "2020-06-24"]).subtracting(newDowDates)
        let newDomDates: Set<String> = Set(["2020-01-01", "2020-01-02", "2020-01-03", "2020-01-04", "2020-01-05", "2020-01-06", "2020-01-07", "2020-01-08", "2020-01-09", "2020-01-10",
                                       "2020-02-01", "2020-02-02", "2020-02-03", "2020-02-04", "2020-02-05", "2020-02-06", "2020-02-07", "2020-02-08", "2020-02-09", "2020-02-10",
                                       "2020-03-01", "2020-03-02", "2020-03-03", "2020-03-04", "2020-03-05", "2020-03-06", "2020-03-07", "2020-03-08", "2020-03-09", "2020-03-10",
                                       "2020-04-01", "2020-04-02", "2020-04-03", "2020-04-04", "2020-04-05", "2020-04-06", "2020-04-07", "2020-04-08", "2020-04-09", "2020-04-10",
                                       "2020-05-01", "2020-05-02", "2020-05-03", "2020-05-04", "2020-05-05", "2020-05-06", "2020-05-07", "2020-05-08", "2020-05-09", "2020-05-10",
                                       "2020-06-01", "2020-06-02", "2020-06-03", "2020-06-04", "2020-06-05", "2020-06-06", "2020-06-07", "2020-06-08", "2020-06-09", "2020-06-10"]).subtracting(newWomDates).subtracting(newDowDates)
    ...
    func testGetDeltaInstancesRecurring_endDateLater() throws {
        
        let newEnd = Calendar.current.date(from: DateComponents(year: 2022, month: 1, day: 1))!
        let targetSets = Set((task.targetSets as! Set<TaskTargetSet>))
        let delta = Set(task.getDeltaInstancesRecurring(startDate: startDate, endDate: newEnd, dayPatterns: Set(targetSets.map{$0.pattern! as! DayPattern}) ))
        XCTAssert(delta.count == 0)
    ...
    func testGetDeltaInstancesRecurring_deleteDow() throws {
    ...
    func testGetDeltaInstancesRecurring_deleteWom() throws {
    ...
    func testGetDeltaInstancesRecurring_deleteDom() throws {
    ...
    func testGetDeltaInstancesRecurring_deleteAllTargetSets() throws {
     ...
     */
    func testGetDeltaInstancesRecurring_addTTS() throws {
     ...
     */
    func testGetDeltaInstancesRecurring_addWomDowDom_deleteDow() throws {
...
extension Task_InstanceDeltaTests {
    ...
    func testGetDeltaInstancesRecurring_performance_fiveYears_deleteOneTTS() {
    ...
    func testGetDeltaInstancesRecurring_performance_tenYears_deleteOneTTS() {
    ...
    func testGetDeltaInstancesRecurring_performance_twentyFiveYears_deleteOneTTS() {
