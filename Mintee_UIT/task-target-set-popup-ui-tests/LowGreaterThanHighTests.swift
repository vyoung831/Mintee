...
class LowGreaterThanHighTests: XCTestCase {
    ...
    override func setUpWithError() throws {
        ...
        app.textFields["minimum-value"].typeText("4")
...
extension LowGreaterThanHighTests {
    ...
    func testLessThanNA() throws {
        ...
        let ttsvQuery = app.scrollViews.buttons.matching(identifier: "task-target-set-view")
        XCTAssert(ttsvQuery.count == 1)
        XCTAssert(ttsvQuery.allElementsBoundByIndex[0].value as! String == "Monday. Every week. Target > 4")
...
extension LowGreaterThanHighTests {
    ...
    func testNANA() throws {
        ...
        // Verify that done button is disabled
